...
public class GotohTest {
	...
	public static void main(String[] args) {
		...
		FreeshiftSequenceGotoh gotoh = new FreeshiftSequenceGotoh(-12.0d, -1.0d,
				matrix);
		try {
			br = new BufferedReader(new InputStreamReader(new FileInputStream(
					infile)));
...
//				System.out.println((content[0].trim()));
//				System.out.println(seqlib.get(content[0].trim()));
				seq1 = new Sequence(content[0].trim(), seqlib.get(content[0]
						.trim()));
				seq2 = new Sequence(content[1].trim(), seqlib.get(content[1]
						.trim()));
				ali = gotoh.align(seq1, seq2);
				// gotoh.check(ali);
//				System.out.println(">" + line + " "
//						+ String.format(Locale.US, "%.3f", ali.getScore()));
//				System.out.println(ali1);
//				System.out.println(ali2);
//				System.out.println(content[0].trim() + ": "
//						+ ali.getRowAsString(0));
//				System.out.println(content[1].trim() + ": "
//						+ ali.getRowAsString(1));
				// gotoh.streamMatricesAsHtml(new BufferedWriter(new
				// OutputStreamWriter(new
				// FileOutputStream("/Users/andreseitz/Desktop/test.ali"))));
			}
			br.close();
